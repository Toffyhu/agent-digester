...
6. 自然语感: 长短句交替，像人在说话而非讲课

输出JSON: {"simplified":"简化后全文（包含概念映射、误解纠偏和论证拆解）","concept_map":[{"原文":"艰涩术语","白话":"日常理解","misconception":"常见误解","correction":"正确理解"}],"logic_chain":"原文的逻辑链条描述","changes":["改动1"]}
只输出JSON。"""
